...
const ProductImageZoom: React.FC<ProductImageZoomProps> = ({
	...
	return (
		...
		>
			<Image src={imageSrc} alt={imageAlt} className="transition-transform duration-200 ease-out object-cover w-full h-full" width={500} height={500} style={{ transformOrigin: "top left", transform: isZoomed ? imageTransform : "scale(1)" }} />
		</div>
	);
};
