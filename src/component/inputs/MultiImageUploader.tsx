  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {imageList.map((item, index) => (
        ...
        >
          <img src={getPreviewUrl(item.path) || "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"} alt="Uploaded" className="w-full h-full object-cover rounded-md" />
          <button
