...
interface ProductSectionFourProps {
    productList: Product[];
    contentData: any;
}

const ProductSectionFour: React.FC<ProductSectionFourProps> = ({ productList, contentData }) => {
    if (!contentData?.isProductSectionFourVisible) return null;
    ...
    return (
        <div className='max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto px-4'>
            <div className="mt-6 mb-4">
                ...
                style={{
                    backgroundColor: contentData?.productSectionFourBackgroundColor,
                    color: contentData?.productSectionFourFontColor,
                }}
                >
                    {contentData?.productSectionFourTitle}
                </p>
            </div>
