...
interface ProductSectionFiveProps {
    productList: Product[];
    contentData: any;
}

const ProductSectionFive: React.FC<ProductSectionFiveProps> = ({ productList, contentData }) => {
    if (!contentData?.isProductSectionFiveVisible) return null;
    ...
    return (
        <div className='max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto px-4'>
            <div className="mt-6 mb-4">
                ...
                style={{
                    backgroundColor: contentData?.productSectionFiveBackgroundColor,
                    color: contentData?.productSectionFiveFontColor,
                }}
                >
                    {contentData?.productSectionFiveTitle}
                </p>
            </div>
