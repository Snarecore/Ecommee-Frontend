  ...
  return (
    <>
      ...
      <div className="max-w-screen-2xl mx-auto px-4 py-4 my-4">
        <div>
          <Image src={response?.image} alt={response?.imageAltText} className="w-full h-[550px]" width={500} height={500} />
          <p className="text-2xl font-bold mt-8">{response?.title}</p>

          <div className="flex items-center gap-2 mt-3">
            <Image src={response?.image} alt="Author" className="w-8 h-8 rounded-full" width={32} height={32} />
