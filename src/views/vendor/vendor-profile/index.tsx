                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-6">
                            <div className="flex-shrink-0">
                                {vendorData?.profile?.profileImage ? (
                                    <Image src={vendorData.profile.profileImage || "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"} alt={vendorData.name} className="rounded-full w-24 h-24 sm:w-32 sm:h-32 object-cover border-4 border-[var(--color-green-secondary)] shadow-lg" width={96} height={96} />
                                ) : (
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 hover:shadow-md transition-shadow">
                                        ...
                                        {vendorData?.profile?.shopImage ? (
                                            <Image src={vendorData.profile.shopImage || "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"} alt={vendorData.profile.shopName || ""} className="w-32 h-32 object-cover rounded-xl border-2 border-[var(--color-green-primary)] shadow-md" width={128} height={128} />
                                        ) : (
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-start space-x-4">
                                        ...
                                        {shopPreview && (
                                            <div className="relative w-[120px] h-[120px] mt-2">
                                                <Image src={shopPreview || "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"} alt="Shop Preview" className="w-full h-full object-cover rounded-md border border-gray-300" width={500} height={500} />
                                                <button
