...
const ChatTable = ({ dataList, fetchData, pageCount,
    currentPageNumber,
    ...
    const [selectedMessage, setSelectedMessage] = useState<InboxTableDataProps | null>(null);

    const openDeleteModal = (data: InboxTableDataProps) => {
