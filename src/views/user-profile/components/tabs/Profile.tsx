                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-6">
                            <div className="flex-shrink-0">
                                {userData.profile?.profileImage ? (
                                    <Image src={userData.profile.profileImage} alt={userData.name} className="rounded-full w-24 h-24 sm:w-32 sm:h-32 object-cover border-4 border-[var(--color-green-secondary)] shadow-lg" width={96} height={96} />
                                ) : (
