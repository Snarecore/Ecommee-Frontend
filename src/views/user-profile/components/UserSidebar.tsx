					...
					<div className="mb-6 flex gap-4 items-center">
						<div className="flex items-center gap-4">
							<div className="w-18 h-18">
								<Image src={userData?.profile?.profileImage || null} alt={userData?.name} className="rounded-full object-cover shadow-lg border-2 border-[var(--color-green-primary)]" width={500} height={500} />
							</div>
